const route_listener = document.getElementById('g-route-listener') as HTMLDivElement
const route_order = ['#', '#about', '#works', '#contact']
let selected_route = '#'
let selected_page = document.querySelector('main>[data-selected]') as HTMLDivElement
let is_animate = false

function update_page(pathname: string, animation=true){
	...
	const callback = () => {
		...
		selected_page = document.querySelector(`main>div[data-page-target="${CSS.escape(pathname)}"]`) as HTMLDivElement
...
function init_navigation_btn() {
	const nav_element = document.getElementById('h-navigation') as HTMLElement
...
function init_custom_btn() {
	const mp_home_btn = document.getElementById('mp-home-btn') as HTMLButtonElement
	mp_home_btn.onclick = () => update_page('#contact')

	const h_logo_btn = document.getElementById('h-logo-btn') as HTMLButtonElement
...
function init_dialog_navigation() {
	const menu_btn = document.getElementById('h-menu') as HTMLButtonElement
	const navigation_dialog = document.getElementById('h-dialog') as HTMLDialogElement
	const close_dialog_btn = document.getElementById('h-dialog-close') as HTMLButtonElement
