...
let resize_timeout_id: ReturnType<typeof setTimeout> | undefined

function reposition_blocks(p_opacity: boolean =true){
	 ...
	 */
	const prohibited_area: [X1: number, X2: number, Y1: number, Y2: number][] = []
